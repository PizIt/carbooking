                                ...
                                <form method="POST" name="form" data-toggle="validator" role="form">
                                        <div class="row">
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input type="text" id="dateSave" class="form-control border-input" name="pk_date_save" 
                                                       value="{{!empty($pickup->pk_date_save) ? $dateSave: ''}}">
                                            </div>
                                            <div class="col-md-1 form-group">
                                                <label>เบิกครั้งที่</label>
                                                <input type="text" class="form-control border-input" name="pk_no" value="{{!empty($pickup->pk_no) ? $pickup->pk_no : ''}}">
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <label>ประจำเดือน</label>
                                                <select class="form-control border-input" name="pk_month">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select class="form-control border-input" name="pk_id_driver">
...
<!--                                                <option>User1  (หัวหน้าช่าง)</option>-->
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select class="form-control border-input" name="pk_car_id">
                                                @foreach($cars as $c)
...
<!--                                            <option>มม 5591 กรุงเทพมหานคร(รถตู้)</option>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select class="form-control border-input" name="pk_type_fuel">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="number" class="form-control border-input" name="pk_qty" value="{{!empty($pickup->pk_qty) ? $pickup->pk_qty : ''}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="text" class="form-control border-input" name="pk_early_km" value="{{!empty($pickup->pk_early_km) ? $pickup->pk_early_km : ''}}" required>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label>เบิกครั้งนี้เข็มไมลค์</label>
                                            <input type="text" class="form-control border-input" name="pk_now_km" value="{{!empty($pickup->pk_now_km) ? $pickup->pk_now_km : ''}}" required>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label>เลขที่ใบสั่งจ่าย</label>
                                            <input type="text" class="form-control border-input" name="pk_order_no" value="{{!empty($pickup->pk_order_no) ? $pickup->pk_order_no : ''}}" required>
                                        </div>
                                    </div>
                                        @if(!empty($pickup->id))
